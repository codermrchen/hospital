...
<hr>
    <div class="layui-form-item" style="margin-left: 20px">
        ...
        <div class="layui-input-inline">
            <input type="text" name="username" lay-verify="required" value="${clb[0].username}"  class="layui-input">
        </div>
    </div>
    ...
    <div class="layui-form-item" style="margin-left: 20px">
        ...
        <div class="layui-input-inline">
            <input type="text" name="username" lay-verify="required" value="${clb[0].result}"  class="layui-input">
        </div>
    </div>
